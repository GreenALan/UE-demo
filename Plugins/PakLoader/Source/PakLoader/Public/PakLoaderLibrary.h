...
public:
	...
	*/
	...
	UFUNCTION(BlueprintPure, Category= "PakLoader")
	static ULevel* GetPakFileLevel(const FString& Filename);

	UFUNCTION(BlueprintPure, Category = "PakLoader")
	static UMaterialInstance* GetPakFileMaterialInstance(const FString &Filename);

	UFUNCTION(BlueprintPure, Category = "PakLoader")
	static FString GetIOSDocumentPakPath(const FString& Filename);
};
