...
// #include "OpenGLDrv/Public/OpenGLES.h"
...
// 	if (true)
// 	{
// 		FString Version = FOpenGL::GetAdapterName(GL_EXTENSIONS);
// 		FString Extensions = FOpenGL::GetExtensionsString();
//
// 		UE_LOG(LogTemp, Warning, TEXT("OpenGL ES Version: %d.%d"), (Version >> 16) & 0xffff, Version & 0xffff);
// 		UE_LOG(LogTemp, Warning, TEXT("Supported OpenGL ES Extensions: %s"), *Extensions);
// 	}
// }
